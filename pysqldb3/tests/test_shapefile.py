...
class TestWriteShpPG:
    ...
    def test_write_shp_table_pth(self):
        ...
        # Reupload as table
        db.shp_to_table(path=f'{fp}\\{shp_name}', schema=pg_schema, table=test_reuploaded_table_name, print_cmd=True)
    ...
    def test_write_shp_table_pth_w_name(self):
        ...
        # Reupload as table
        db.shp_to_table(path=f'{fp}\\err_{shp_name}', shp_name=shp_name ,schema=pg_schema,
...
class TestWriteShpMS:
    ...
    def test_write_shp_table_pth(self):
        ...
        # Reupload as table
        sql.shp_to_table(path=f'{fp}\\{shp_name}', schema=ms_schema, table=test_reuploaded_table_name, print_cmd=True)
